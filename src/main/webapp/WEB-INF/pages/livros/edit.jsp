...
<body>
   ...
   <form action="<c:url value="/livros/update" />" method="post">
	  ...
	  <div class="custom-control custom-checkbox">
		  <input type="checkbox" class="custom-control-input" id="emprestado" name="emprestado" value="${livro.emprestado}" checked="${livro.emprestado}">
	  	  <label class="custom-control-label" for="emprestado">Emprestado</label>
	  </div>      
      <br/>
